package com.quartzdesk.ws_examples.ws_quartz_exec_notif_rule.v1;

import com.quartzdesk.service.client.quartz_exec_notif_rule.v1_0.QuartzExecNotificationRuleServiceClient;
...
import com.quartzdesk.service.types.v4_0.connection.SchedulerConnection;
import com.quartzdesk.service.types.v4_0.jmx.JmxProtocol;
import com.quartzdesk.service.types.v4_0.jmx.RemoteJmxService;
import com.quartzdesk.service.types.v4_0.scheduler.SchedulerType;
import com.quartzdesk.service.types.v4_0.scheduler.quartz.QuartzExecNotificationRule;
...
public class QuartzExecNotificationRuleServiceExample
{
  ...
  private static final String WS_QUARTZ_EXEC_NOTIF_RULE_SERVICE_ENDPOINT_URL =
      "http://localhost:8080/quartzdesk/services/quartz_exec_notif_rule/v1_0/QuartzExecNotificationRuleService";
