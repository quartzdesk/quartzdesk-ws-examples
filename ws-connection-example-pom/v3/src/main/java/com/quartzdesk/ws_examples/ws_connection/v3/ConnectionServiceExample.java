package com.quartzdesk.ws_examples.ws_connection.v3;

import com.quartzdesk.service.client.connection.v3_0.ConnectionServiceClient;
...
import com.quartzdesk.service.types.v4_0.connection.Connection;
import com.quartzdesk.service.types.v4_0.connection.ConnectionFolder;
...
public class ConnectionServiceExample
{
  ...
  private static final String WS_CONNECTION_SERVICE_ENDPOINT_URL =
      "http://localhost:8080/quartzdesk/services/connection/v3_0/ConnectionService";
